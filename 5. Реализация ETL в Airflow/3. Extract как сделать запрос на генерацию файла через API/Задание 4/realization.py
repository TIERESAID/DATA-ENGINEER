...
def create_files_request( headers):
    api_conn = *ваш код здесь*
    api_endpoint = *ваш код здесь*

    method_url = '/generate_report'
    r = requests.post('https://'+ *ваш код здесь*, headers=headers)
...
task = PythonOperator(task_id='create_files_request',
                                        python_callable=*ваш код здесь*,
                                        op_kwargs=*ваш код здесь*,
                                        dag=dag)
